...
export default function Home({ onChangePage, onOpenQuoteModal }: HomeProps) {
  ...
  return (
    <div className="bg-white font-sans text-slate-700">
      ...
      {/* 1. HERO BANNER */}
      <section className="relative min-h-screen flex items-center bg-primary overflow-hidden pt-12 md:pt-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 md:py-24 grid grid-cols-1 lg:grid-cols-[minmax(0,42rem)_1fr] gap-y-12 lg:gap-y-6 lg:gap-x-16 justify-items-center lg:justify-items-stretch items-center">
          ...
          <div className="order-1 lg:col-start-1 lg:row-start-1 w-full text-center lg:text-left space-y-6 max-w-2xl">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-display font-black text-white leading-tight tracking-tight">
            ...
            <div className="flex sm:hidden items-stretch justify-center gap-2 w-full">
              ...
              <a 
                ...
                className="flex-1 flex items-center justify-center gap-1.5 bg-[#25D366] hover:bg-[#20ba56] text-white font-bold text-sm px-3 py-2.5 rounded-lg shadow-lg shadow-green-500/10 transition-all duration-300 active:scale-95"
              >
            ...
            <div className="hidden sm:flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4">
              ...
              <button 
                ...
                className="group relative overflow-hidden flex items-center gap-2 bg-white/10 hover:bg-white text-white hover:text-slate-900 font-bold text-sm sm:text-base px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl border border-white/20 hover:border-white transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] active:scale-95 shadow-lg hover:shadow-white/5"
              >
                <span className="relative z-10 flex items-center gap-2">
                  Request Free Quote
                  <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 group-hover:translate-x-1.5 transition-transform duration-300 text-accent group-hover:text-accent-dark" />
                </span>
              </button>
            </div>
          </div>
